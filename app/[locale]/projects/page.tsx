...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    keywords: ["projects", "WeTrack", "Dokker Space", "apps", "tools", "productivity", "openfly projects", "conscious living"],
    alternates: {
      canonical: "/projects",
    },
    openGraph: {
      title: "Our Projects - OpenFly",
      description: "Explore our innovative projects designed to help people live balanced, fulfilling lives.",
      url: "/projects",
      images: [
        {
